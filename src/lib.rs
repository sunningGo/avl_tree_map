...
// Implement Default without using the associated derive macro. (The impl
// generated by the derive macro has a where clause that requires K: Default and
// V: Default. The following impl does not impose such a requirement.)
