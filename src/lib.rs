...
// Implement Clone without using the corresponding derive macro in order to
...
// Implement Default without using the corresponding derive macro in order to
// avoid requiring K: Default and V: Default
